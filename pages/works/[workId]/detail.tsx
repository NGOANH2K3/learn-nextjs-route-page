        ...
        <Box>
            <Container>
                ...
                <Stack direction={'row'} my={2}>
                    ...
                    <Chip color='primary' label={new Date(Number.parseInt(work.createdAt)).getFullYear()}  size='small'/>
                ...
                <Box component={'div'} dangerouslySetInnerHTML={{ __html: work.fullDescription}} sx={{img: {width: '100%'}}}></Box>
            </Container>
        </Box>
    )
}
